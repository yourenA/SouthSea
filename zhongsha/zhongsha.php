    ...
    <div class="center">
        <div class="center-content">
            <div class="center-content-article">
                <img src="../images/South.jpg" alt=""><h2>中沙群岛</h2>南海是一个位于东南亚，被中国大陆、台湾本岛、菲律宾群岛、马来群岛及中南半岛所环绕的陆缘海，为西太平洋的一部分。中国汉代、南北朝时称其为涨海、沸海，清代以后逐渐改称南海，并延续至今。新加坡、马 来西亚、印尼及英殖民时期的香港等从国际上通用的英语名称“South China Sea”称之为南中国海。南海海域面积有350万平方公里，其中有超过200个无人居住的岛屿和岩礁，这些岛礁被合称为南海诸岛。除了是主要的海上运输航线外，南海据信还蕴藏着丰富的石油和天然气。
            ...
            $query1="select count(*) as total from db_zhongsha order by N_id desc";
            ...
            $sql1=@mysql_query("select * from db_zhongsha order by N_id limit $offset1, $page_size1");
            ...
            <div class="center-content-list">
                ...
                <ul>
                    ...
                    do{
                        ...
                        <li>
                            <div>
                                <a href="huangyandao.php?id=<?php echo $row1->N_id; ?>&belong=<?php echo $row1->N_belong; ?>" >
                ...
                <table class="table"   border="0" cellspacing="10" >
                    <tr>
                        ...
                        if($page1!=1){
                            /*  显示“首页”超链接  */
                            echo  "<td ><a style='color:black;' href='zhongsha.php?page1=1'>首页</a> </td>";
                            /*  显示“上一页”超链接  */
                            echo "<td><a style='color:black;'  href=zhongsha.php?page1=".($page1-1).">上一页</a></td>";
                        }else{
                            /*  显示“首页”超链接  */
                        ...
                        if($page1<$page_count1){
                            /*  显示“下一页”超链接  */
                            echo "<td><a style='color:black;'  href=zhongsha.php?page1=".($page1+1).">下一页</a></td>";
                            /*  显示“尾页”超链接  */
                            echo  "<td><a style='color:black;'  href=zhongsha.php?page1=".$page_count1.">尾页</a></td>";
                        }else{
                            /*  显示“下一页”超链接  */
