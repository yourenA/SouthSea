        ...
        <div class="body">
            <div class="body-top">
                <div class="body-top-pic" id="body-top-pic">
                    ...
                    <ul id="ul">
                        <li>
                            <img src="images/yongshu.jpg" alt="">
                            <p class="body-top-pic-text">这里是简介1.....</p>
                        </li>
                        <li>
                            <img src="images/zhongye.jpg" alt="">
                            <p class="body-top-pic-text">这里是简介2.....</p>
                        </li>
                        <li>
                            <img src="images/yongshu.jpg" alt="">
                            <p class="body-top-pic-text">这里是简介3.....</p>
                        </li>
                        <li>
                            <img src="images/taiping.jpg" alt="">
                            <p class="body-top-pic-text">这里是简介4.....</p>
                        </li>
                    </ul>
