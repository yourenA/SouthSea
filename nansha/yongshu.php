...
$id=$_GET['id'];
$belong=$_GET['belong'];
$sql = mysql_query("select * from db_nansha where N_id='$id'");
                    ...
                    <div class="page">
                        <table class="table"   border="0" cellspacing="10" >
                            <tr>
                                ...
                                if($page!=1){
                                    /*  显示“首页”超链接  */
                                    echo  "<td ><a style='color:black;' href='yongshu.php?page=1'>首页</a> </td>";
                                    /*  显示“上一页”超链接  */
                                    echo "<td><a style='color:black;'  href=yongshu.php?page1=".($page-1).">上一页</a></td>";
                                }else{
                                    /*  显示“首页”超链接  */
                                ...
                                if($page<$page_count1){
                                    /*  显示“下一页”超链接  */
                                    echo "<td><a style='color:black;'  href=yongshu.php?page1=".($page+1).">下一页</a></td>";
                                    /*  显示“尾页”超链接  */
                                    echo  "<td><a style='color:black;'  href=yongshu.php?page1=".$page_count.">尾页</a></td>";
                                }else{
                                    /*  显示“下一页”超链接  */
