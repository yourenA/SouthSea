...
<div class="container">
    ...
    <div class="updateForm">
        <form  name="form1" action="checkEditIslandBuild.php" method="post">
            <table>
                <tr>
                ...
                <tr>
                    <td><input class="input" type="text" name="name" id="name" value="<?php echo $row->B_name;?>"></td>
                    <td>
                    ...
                    <td><textarea name="desc" id="text" cols="40" rows="20"><?php echo $row->B_desc;?></textarea></td>
                    <td><textarea name="start" id="text" cols="40" rows="20"><?php echo $row->B_start;?></textarea></td>
                    <td><textarea name="pass" id="text" cols="40" rows="20"><?php echo $row->B_pass;?></textarea></td>
                    <td><textarea name="now" id="text" cols="40" rows="20"><?php echo $row->B_now;?></textarea></td>
                </tr>
                <tr>
                    <td colspan="6">
