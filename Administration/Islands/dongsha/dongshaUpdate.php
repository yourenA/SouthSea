...
<body style="background:  rgb(264,220,200)">
    <div class="container">
        ...
        <div class="updateForm">
            <form action="checkdongshaUpdate.php" method="post">
                <table>
                    <tr>
                    ...
                    <tr>
                        <td><label for="belong">所属:</label></td><td><input type="text" name="belong" id="belong" readonly value="dongsha"></td>
                    </tr>
                    <tr>
                        <td><label for="pic">图片:</label></td><td><img style="height: 100px;width: auto" src="../../../dongsha/<?php echo $row->N_pic;?>" alt=""></td>
                    </tr>
                    <tr>
