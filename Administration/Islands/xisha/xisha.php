...
include('../../../conn.php');
$sql = mysql_query("select * from db_xisha  ");
    ...
    <script>
        ...
        function del(id){
            if(window.confirm("你确定要删除吗，删除后不可恢复！")){
                window.location='checkxishaDel.php?id='+id;
            }
        }
    </script>
</head>
...
<div class="container">
    ...
    <div class="formDiv">
        <form name="form" method="post" action="">
            ...
            <input type="button" class="btn addbtn" value="添加岛礁" onclick="window.location.href='xishaAdd.php'">
        </form>
    </div>
    ...
    <div class="tableDiv">
        ...
        <table>
            ...
            $sql = mysql_query("select * from db_xisha where  N_name  like '%$keyword%' or  N_text like '%$keyword%'");
            $row=mysql_fetch_object($sql);
            if(!$row){
            ...
            do {
                ...
                <tr>
                    ...
                    <td><img src="../../../xisha/<?php echo $row->N_pic;?>"></td>
                    ...
                    <td><a href="xishaUpdate.php?id=<?php echo $row->N_id;?>">修改</a>
                        &nbsp;<a href="javascript:;" onclick="return del(<?php echo $row->N_id;?>)" >删除</a><br/>
                        <a href="xishaShowComment.php?id=<?php echo $row->N_id;?>&belong=xisha&name=<?php echo $row->N_name;?>">查看留言</a></td>
                </tr>
                <?php
