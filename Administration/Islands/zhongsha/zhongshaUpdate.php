...
<body style="background:  rgb(264,220,200)">
    <div class="container">
        ...
        <div class="updateForm">
            <form action="checkzhongshaUpdate.php" method="post">
                <table>
                    <tr>
                    ...
                    <tr>
                        <td><label for="pic">图片:</label></td><td><img style="height: 100px;width: auto" src="../../../zhongsha/<?php echo $row->N_pic;?>" alt=""></td>
                    </tr>
                    <tr>
