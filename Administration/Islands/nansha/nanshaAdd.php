...
<div class="container">
    ...
    <div class="updateForm">
        <form action="checknanshaAdd.php" method="post"   enctype="multipart/form-data">
            <table>
                <tr>
                ...
                <tr>
                    <td><input type="hidden" name="id" value="<?php echo $row->N_id;?>"></td><td><input class="btnUpdate" type="button" onclick=" history.back(-1);" value="取消"></td>
                </tr>
