...
<body style="background:  rgb(264,220,200)">
    <div class="container">
        ...
        <div class="updateForm">
            <form action="checknanshaUpdate.php" method="post">
                <table>
                    <tr>
                    ...
                    <tr>
                        <td><label for="belong">所属:</label></td><td><input type="text" name="belong" id="belong" readonly value="nansha"></td>
                    </tr>
                    <tr>
                        <td><label for="pic">图片:</label></td><td><img style="height: 100px;width: auto" src="../../../nansha/<?php echo $row->N_pic;?>" alt=""></td>
                    </tr>
                    <tr>
