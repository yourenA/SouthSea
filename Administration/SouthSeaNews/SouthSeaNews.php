...
include('../../conn.php');
$sql = mysql_query("select * from db_news order by D_date desc ");
    ...
    <script>
        ...
        function del(id){
            if(window.confirm("你确定要删除吗，删除后不可恢复！")){
                window.location='checkNewsDel.php?id='+id;
            }
        }
    </script>
</head>
...
<div class="container">
    ...
    <div class="formDiv">
        <form name="form" method="post" action="">
            ...
            <input type="button" class="btn addbtn" value="添加南海动态" onclick="window.location.href='SouthSeaNewsAdd.php'">
        </form>
    </div>
    ...
    <div class="tableDiv">
        ...
        <table id="news">
            ...
            $keyword=@$_POST['keyword'];
              $sql = mysql_query("select * from db_news where content like '%$keyword%' or title like  '%$keyword%' or introduction like '%$keyword%'   order by D_date desc ");
            $row=mysql_fetch_object($sql);
            if(!$row){
            ...
            do {
                ...
                <tr>
                    ...
                    <td class="edit">
                        <a href="showSouthSeaNews.php?id=<?php echo $row->id;?>&belong=<?php echo $row->belong;?>">查看</a><br/>
                        <a href="editSouthSeaNews.php?id=<?php echo $row->id;?>&belong=<?php echo $row->belong;?>">编辑</a><br/>
