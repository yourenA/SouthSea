...
include('../../conn.php');
$sql = mysql_query("select * from db_kuangchan order by K_id desc ");
    ...
    <script>
        ...
        function del(id){
            if(window.confirm("你确定要删除吗，删除后不可恢复！")){
                window.location='checkKuangchanDel.php?id='+id;
            }
        }
    </script>
</head>
...
<div class="container">
    ...
    <div class="formDiv">
        <form name="form" method="post" action="">
            ...
            <input type="button" class="btn addbtn" value="添加资源信息" onclick="window.location.href='kuangchanAdd.php'">
        </form>
    </div>
    <div class="resourceBox">
        <ul>
            ...
            $sql = mysql_query("select * from db_kuangchan where K_name like '%$keyword%' ");
            $row=@mysql_fetch_object($sql);
            if(!$row){
            ...
            <li>
                <div class="item">
                    <div class="item-top">
                        <img src="../../resource/<?php echo $row->K_image;?>" alt="">
                    </div>
                    <div class="item-center">
                        <span><?php echo $row->K_name;?></span>
                    </div>
                    <div class="item-bottom">
                        <a href="showSouthSeaResource-kuangchan.php?id=<?php echo $row->K_id;?>">查看</a>
                        <a href="editSouthSeaResource-kuangchan.php?id=<?php echo $row->K_id;?>">编辑</a>
                        <a  href="javascript:;" onclick="return del(<?php echo $row->K_id;?>)" >删除</a>
                    </div>
                </div>
            </li>
                <?php
