...
<div class="head-search">
    ...
    <!--中间正文-->
    <div class="center">
        <div class="center-banner-top" style="background:url('banner3.png') center;  ">
        </div>
            ...
            <div>
                ...
                <ul class="blog-left-content-list">
                    ...
                    */
                    ...
                    $result=mysql_query("select * from  db_news where belong='weiquan'  order by D_date desc  ");
                    ...
                    $sql="select * from db_news where belong='weiquan'  order by D_date desc  limit $offset,$Page_size" ;//select * from table limit 开始的条数，要显示的条数
