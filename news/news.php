...
<div class="head-search">
    ...
    <div class="center">
        ...
        <div class="center-news">
            <div class="center-news-dongtai">
                <p class="news-title">新闻动态</p>
                <div class="mask"></div>
                <a href="dongtai.php"><img src="dongtai.jpg" alt=""></a>
            </div>
            <div class="center-news-weiquan">
                <p class="news-title">南海维权</p>
                <div class="mask"></div>
                <a href="weiquan.php"><img src="weiquan.jpg" alt=""></a>
            </div>
        </div>
    </div>
    <!--脚部内容-->
