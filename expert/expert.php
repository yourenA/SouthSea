            ...
            <div>
                ...
                <ul class="blog-left-content-list">
                    ...
                    */
                    ...
                    $result=mysql_query("select * from  db_expert ");
                    ...
                    $sql="select * from db_expert order by D_date desc limit $offset,$Page_size" ;//select * from table limit 开始的条数，要显示的条数
                    ...
                    do{
                        ?>
                        <li class="expert">
                            <h3><i class="fa fa-user"></i> <a href="expertPage.php?id=<?php echo $row->id;?>"><?php echo $row->title;?></a></h3>
                            <div class="expert-left">
                                <div class="blog-left-content-list-date"><?php echo $row->D_date;?></div>
                                <div class="blog-left-content-list-body2">
                                    <?php echo $row->introduction;?>
                                </div>
                                <div class="read-more"><a href="expertPage.php?id=<?php echo $row->id;?>">阅读全文 &raquo;</a></div>
                            </div>

                            <div class="expert-right">
                                <div  class="expert-pic"><img src="<?php echo $row->image;?>" alt=""></div>
