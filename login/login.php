...
<div class="container" style="margin-top: 100px">
    <h2 style="font-size: 36px;height: 36px;text-align: center;margin-top: 80px;font-weight: 600;color: #333">南海群岛用户登录</h2>
    <!--头部-->
    <div class="content">
            ...
            <form action="check_login.php" method="post" onSubmit="return InputCheck(this)">
                ...
                <div class="botton">
                    <p class="pclass3">
                        ...
                        <a href="register.php" style="width: 47px;font-size: 13px;display: block;height: 30px;line-height:30px;padding: 0;" class="spanclass2 aid2">注册</a>
                    </p>
                </div>
            </form>
        </div>
