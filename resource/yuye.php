...
<div class="head-search">
    ...
    <div class="yuye">
	 <div class="center-build-title">
                <h1>南海鱼类设</h1>
                <p>波澜壮阔的大海、风光旖旎的小岛、千姿百态的生物……南海是我国的一颗明珠。浩瀚的南海是孕育生命的摇篮，它哺育从几毫米长的蜱螨类、棘头虫类到长30多米、重达160多吨的蓝鲸等形形色色的海洋生物。</p>
                <p>南海鱼虾贝蟹3000多种，其中又以各种鱼类居多。大黄鱼、马鲛鱼、石斑鱼、金枪鱼、乌鲳鱼、银鲳鱼……其中的大黄鱼是一种重要的海产资源。这里的鱼类从不游往外国的海域，似乎恋着自己的家乡，因而有“中国家鱼”的美称。资料显示，南海已知鱼类种数为东海的1.4倍，为黄海、渤海的3.56倍。仅南海北部大陆架的鱼类有1027种，远高于东海的727种和黄海的289种；而在南海大陆斜坡和南海诸岛海域也分别记录了205种和523种鱼类。全国海域的头足类为92种，南海北部有记录的就有73种。光是南海北部，就有对虾100多种。</p>

           </div>

            <div class="yuye-content-list">
                <ul>
                    <?php
                    /*
                    ...
                    */
                    ...
                    $result=mysql_query("select * from  db_yuye");
                    ...
                    $sql="select * from db_yuye order by Y_id desc limit $offset,$Page_size" ;//select * from table limit 开始的条数，要显示的条数
                    $result=mysql_query($sql);
                    $row=mysql_fetch_object($result);

                    do{
                        ?>
                        <li><a href="yuyePage.php?id=<?php echo $row->Y_id;?>"><img src="<?php echo $row->Y_image;?>" alt=""><p><?php echo $row->Y_name;?></p></a></li>
